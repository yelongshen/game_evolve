...
if __name__ == "__main__":
    ...
    try:
        ...
        run_sim(steps=200000, N=20, history_len=512, p_death=0.002, log_every=300, out_csv="sim_log_new.csv", pairs_per_step=8, train_every=24, verbose=verbose, device=device, payoff_type=payoff_type, community_type=community_type, algorithm=algorithm)
